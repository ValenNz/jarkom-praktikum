...
```
![Query A Record](assets/dns_a_record.png)
...
Addresses:  172.67.152.120
            104.21.74.8
```
![Query DNS Publik](assets/dns_compare.png)
...
```
![DNS Cache](assets/ipconfig_displaydns.png)
...
```
**Hasil Wireshark:**
![DNS MIT](assets/wireshark_dns_nslookup.png)
...
1. DNS menerjemahkan nama domain → IP; proses ini melibatkan hierarki: client → DNS lokal → root/TLD → authoritative server.
